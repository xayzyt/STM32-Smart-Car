...
[![STM32 智能小车循迹演示](docs/media/demo-cover.jpg)](docs/media/smart-car-demo.mp4)

点击封面播放 [10 秒智能小车循迹演示](docs/media/smart-car-demo.mp4)。公开版本已压缩为 720p H.264，并移除拍摄设备元数据。
